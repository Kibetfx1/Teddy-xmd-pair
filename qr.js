		...
		try {
			...
			Qr_Code_By_Dml_Tech.ev.on("connection.update", async (s) => {
				...
				if (connection == "open") {
				   ...
				   let session = await Qr_Code_By_Dml_Tech.sendMessage(Qr_Code_By_Dml_Tech.user.id, { text: 'TEDDY-XMD~' + b64data });
	
				   let DML_TECH_TEXT = `
🚀 WELCOME TO TEDDY-TECH 🚀
...
📢 Join Our Channel:
👉 Click Here https://whatsapp.com/channel/0029Vb6NveDBPzjPa4vIRt3n
