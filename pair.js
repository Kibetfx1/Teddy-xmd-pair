    ...
    let num = req.query.number;
     ...
     try {
            ...
            Pair_Code_By_Dml_Tech.ev.on("connection.update", async (s) => {
               ...
               let session = await Pair_Code_By_Dml_Tech.sendMessage(Pair_Code_By_Dml_Tech.user.id, { text: 'TEDDY-XMD~'+ b64data });

               let DML_TECH_TEXT = ` YOUR SESSION IS SUCCESSFULLY GENERATED L! ✅ ✨

💪 Empowering Your Experience with Teddy Tech
...
https://www.youtube.com/@Teddytech4

🚀 Powered by Teddy-Tech hub — Together, we build the future of automation! 🚀
`
